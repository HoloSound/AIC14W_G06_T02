...
public class Raid1Servlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		if(UPLOAD_OPERATION.equals(req.getParameter("task"))){//lets upload a file
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		try {
			...
			if(DELETE_OPERATION.equals(req.getParameter("task"))){//lets delete a file
			...
			if(DOWNLOAD_OPERATION.equals(req.getParameter("task"))){//lets download a file
				String fn = req.getParameter(FILE_NAME);
				if(fn==null){
					error("parameter Error",resp);
					return;
...
//	      factory.setRepository(File.createTempFile("raid", ".tmp"));
